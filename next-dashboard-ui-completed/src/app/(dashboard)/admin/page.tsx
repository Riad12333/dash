    ...
    <div className="space-y-8 p-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">Gérez votre établissement efficacement</p>
        </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500">Intelligence Artificielle (INFO401) - Il y a 2 heures</p>
                </div>
              </div>
              <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                <span className="text-2xl mr-4">👤</span>
                <div>
                  ...
                  <p className="text-sm text-gray-500">Madjid (Étudiant) - Il y a 4 heures</p>
                </div>
              </div>
              <div className="flex items-center p-4 bg-gray-50 rounded-lg">
                <span className="text-2xl mr-4">✅</span>
                <div>
                  ...
                  <p className="text-sm text-gray-500">Systèmes Distribués (INFO402) - Il y a 6 heures</p>
                </div>
              </div>
            </div>
          </CardContent>
